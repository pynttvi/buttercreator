...
export default function CharInfo(props: PropsWithChildren<{}>) {
    ...
    return (
        <SectionBox id={'reinc.info'}>
            <Suspense fallback="Loading...">
                <Typography variant='h4' textTransform={'capitalize'}
                            marginBlock={'40px'}>Char</Typography>
                <Box>
                    <Grid container direction={'row'} xs={12} sm={12} md={12}>
                        <Grid container direction={'row'} xs={6} sm={6} md={6}>
                            <CharItem title={'Hp max'} value={hpMax}/>
                            <CharItem title={'Sp max'} value={spMax}/>
                            <CharItem title={'Str'} value={str}/>
                            <CharItem title={'Dex'} value={dex}/>
                            <CharItem title={'Con'} value={con}/>
                            <CharItem title={'Int'} value={int}/>
                            <CharItem title={'Wis'} value={wis}/>
                            <CharItem title={'Cha'} value={cha}/>
                            <CharItem title={'Hpr'} value={hpr}/>
                            <CharItem title={'Spr'} value={spr}/>
                            <CharItem title={'Size'} value={siz}/>
